# ============================================================================ #
#         CREATE SIMPLE EXECUTABLE LAUNCHER FOR ENVIROANALYZER PRO             #
# ============================================================================ #
# This script creates a simple launcher that can be used as the main executable
# Run this in PowerShell to create the launcher
# ============================================================================ #
...
$LauncherCode | Out-File -FilePath "EnviroAnalyzer_Launcher.ps1" -Encoding UTF8
...
Write-Host "========================================"
Write-Host ""
Write-Host "File: EnviroAnalyzer_Launcher.ps1"
Write-Host ""
Write-Host "To convert to EXE, use one of these tools:"
Write-Host "1. PS2EXE: Install-Module ps2exe -Scope CurrentUser"
Write-Host "   Then: ps2exe .\EnviroAnalyzer_Launcher.ps1 .\EnviroAnalyzer.exe"
Write-Host ""
Write-Host "2. Or use the .vbs file with wscript"
Write-Host ""
